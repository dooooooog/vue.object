...
<div class="wenda">
  <div class="left">
    <div class="left-top">
      <span class="tit">程序员自己的问答社区</span>
      <a class="button">我要提问</a>
    </div>
    <div class="nav">
      <a v-for="item in navs">{{item}}</a>
...
.wenda{
  ...
  .left-top{
    background: url("../../../static/image/wenda_title_bg.png");
    padding: 5% 4%;
    display: flex;
  ...
  .button{
    padding: 1.3% 4%;
    /*不加这个width会导致刷新后这个元素的padding依据父盒子的宽高*/
    width: 12%;
    background: #F01414;
    border-radius:4px;
    color: #fff;
